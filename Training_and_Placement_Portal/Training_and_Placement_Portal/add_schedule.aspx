    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
                <div class="input-field col s3 body-align:center;">
                    ...
                    <asp:TextBox ID="pack" CssClass="validate" runat="server" pattern="^[0-9]{1,2}[.]{1}[0-9]{2}$" title="ex. :3.00, 15.30" required></asp:TextBox>&nbsp;<label>Package</label>
                </div>
         </div>
        <div class="row">
                <div class="input-field col s3 body-align:center;">
        ...
        <div class="row">
                <div class="input-field col s5 body-align:center;">
                    ...
                    <asp:TextBox ID="des" CssClass="validate" runat="server" TextMode="MultiLine" Height="200" Rows="10"></asp:TextBox>&nbsp;<label>Minimum CPI required</label>
                </div>
         </div>
        <div class="row">
