...
<body class="grey lighten-3">
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="visited" runat="server" OnRowDataBound="visited_RowDataBound" AutoGenerateColumns="False" DataKeyNames="cid,sid" DataSourceID="VisitedCompanyDS" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnSelectedIndexChanged="visited_SelectedIndexChanged">
                    <Columns>
        ...
        <asp:UpdatePanel ID="upanel2" runat="server">
            <ContentTemplate>
                <asp:GridView ID="StudentList" runat="server" AutoGenerateColumns="False" DataSourceID="StudentListDS" DataKeyNames="uuid" OnRowDataBound="StudentList_RowDataBound" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                    <Columns>
                        <asp:BoundField DataField="uuid" HeaderText="uuid" SortExpression="uuid" ReadOnly="True" />
                ...
                <asp:SqlDataSource ID="StudentListDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [uuid], [fname], [mname], [lname], [rollno], [active] FROM [MyView] WHERE (([active] = @active) AND ([sid] = @sid))" OnSelecting="StudentListDS_Selecting">
                    <SelectParameters>
